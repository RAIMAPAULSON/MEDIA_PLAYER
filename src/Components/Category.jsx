...
function Category({setremoveCategoryVideoResponse}) {
  ...
  const videoDropped = async(e,categoryId)=>{
    ...
    console.log(`Video id: ${videoId} dropped in category id is : ${categoryId}`);
    try
    {
      // destructured and got data
  ...
  const videoDragStarted=(e,videoDetails,categoryId)=>{
    ...
    // since value should be string we are giving JSON.stringify
    ...
    <Modal
      ...
      >
        ...
        <Modal.Footer>
          ...
          <Button onClick={handleAddCategory} variant="primary" className='btn btn-info'>Add</Button>
        </Modal.Footer>
      </Modal>
